...
<div class="new122">
    ...
    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aServico')) { ?>
        <a href="<?php echo base_url() ?>index.php/servicos/adicionar" class="button btn btn-mini btn-success"
           style="max-width: 160px">
            <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span
                    class="button__text2"> Serviços</span></a>
    <?php } ?>
        ...
        <div class="widget-content nopadding tab-content">
            <table id="tabela" class="table table-bordered ">
                ...
                foreach ($results as $r) {
                    ...
                    if ($configuration['codigo_servico'] == '1') {
                        echo '<td>' . $r->codigo . '</td>';
                    }
                    echo '<td>' . $r->nome . '</td>';
                    ...
                    if ($configuration['codigo_servico'] == '1' && !empty($r->codigo) && $this->permission->checkPermission($this->session->userdata('permissao'), 'aOs')) {
                        echo '   <a style="margin-right: 1%" href="' . base_url() . 'index.php/os/adicionar?idServicos=' . $r->idServicos . '" class="btn-nwe1" title="Ordem de Serviço"><i class="bx bxs-file-plus bx-xs"></i></a>';
                    }
                    echo '</td>';
                    echo '</tr>';
                } ?>
