                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url() . (filter_has_var(INPUT_GET, 'idServicos') ? "?idServicos=" . filter_input(INPUT_GET, 'idServicos', FILTER_VALIDATE_INT) : ''); ?>"
                                      method="post" id="formOs">
