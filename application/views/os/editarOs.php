                                ...
                                <form id="formDesconto" action="<?php echo base_url(); ?>index.php/os/adicionarDesconto"
                                    ...
                                    <div class="span1">
                                        ...
                                        <select style="width: 4em;" name="tipoDesconto" id="tipoDesconto">
                                            ...
                                            <option value="porcento" <?= $result->tipo_desconto == "porcento" ? "selected" : "" ?>>
                                                %
                                            </option>
                                        </select>
                                ...
                                <div class="widget_content nopadding">
                                    <table width="100%" class="table table-bordered" id="tblProdutos">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div align="center">
                                                    <strong>R$ <?php echo number_format($total, 2, ',', '.'); ?><input
                                ...
                                <div class="widget_content nopadding">
                                    <table width="100%" class="table table-bordered" id="tblServicos">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div align="center">
                                                    <strong>R$ <?php echo number_format($totals, 2, ',', '.'); ?><input
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php if(isset($id_servicos)):?>
        adicionarServicoById();

        function adicionarServicoById() {
            const dadosInit = new FormData;
            dadosInit.append('idServico', '<?=$id_servicos?>');
            dadosInit.append('idOsServico', '<?php echo $result->idOs; ?>');

            const url = '<?php echo base_url() ?>index.php/os/adicionarServicoById';
            fetch(url, {
                method: 'POST',
                body: dadosInit
            }).then(r => r.json()).then(data => {
                if (data.result) {
                    $('#descricaoProduto').trumbowyg('execCmd', {
                        cmd: 'insertHTML',
                        param: data.descricao
                    });
                    $("#formOs").submit();
                }
