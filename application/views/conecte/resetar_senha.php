...
<body>
    ...
    <!--Footer-part-->
    <div class="row-fluid">
        <div id="footer" class="span12" style="padding: 10px"> <a class="pecolor" href="https://wa.me/5591989932926?text=<?=urlencode("Oi! Gostaria de falar sobre o mapos")?>" target="_blank">
            <?= date('Y') ?> &copy; NORTE&lt;dev/&gt; - <?php echo $this->config->item('app_name') ?> - Versão: <?= $this->config->item('app_version'); ?>
        </a></div>
    </div>
